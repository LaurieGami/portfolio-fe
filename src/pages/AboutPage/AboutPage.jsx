        ...
        <article className="about-page">
            <div className="about-page__wrap">
                <section className="about-page__section">
                    ...
                    <p className="about-page__txt">I am a full-stack software developer who's passionate about the outdoors and action sports 👩‍💻🌿.</p>
                    ...
                    <p className="about-page__txt">I then joined a passionate all-female dev team working on addressing the gender disparity in the Canadian healthcare referral system, and I am now on the look for my next adventure.</p>

                    <p className="about-page__txt">If you think I'd be a good fit with your team or would like to chat, feel free to <NavLink to="/contact" className="about-page__link">send me a message</NavLink>.</p>
                    
                    <p className="about-page__txt">📍 Currently based in Cranbrook, BC.</p>
                </section>
                                        ...
                                        return (
                                            <ul key={`smallColumn-${i}`} className="about-page__list">
                                                {smallColumn.map(skill => {
                                                    return (
                                                        <li key={skill} className="about-page__list-item">{skill}</li>
                                                    )
                                                })}
                                            </ul>
                                        )
